...
namespace Roulette
{
    class Bets
    {
        public string NumbersBet(int ball,int option, int[]Numbers)
        {
            string x = "";
            for (int i = 0; i < 1; i++)
            {
        ...
        public string RedBlack(int ball, int option, string[] Colors)
        {
            string x = "";
            for (int i = 0; i < 1; i++)
            {
        ...
        public string LowHigh(int ball, int option, string[] Number)
        {
            string x = "";
            if (option == 1)
            {
        ...
        //public string Split(int ball, int option, string[] Number)
        //{
